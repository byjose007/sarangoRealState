export const siteConfig = {
  ...
  description:
    'Vestra / Sarango Real Estate es una agencia inmobiliaria boutique. Cada propiedad se mide, dibuja y documenta antes de llegar al mercado.',
...
export const mapConfig = {
  provider: (process.env.NEXT_PUBLIC_MAP_PROVIDER ?? 'openstreetmap') as 'openstreetmap' | 'static' | 'google' | 'mapbox',
