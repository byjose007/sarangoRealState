...
export const metadata = buildMetadata({
  title: 'Coming soon',
  description: 'Two more Vestra desks open this year. Ask to be told first.',
  path: '/coming-soon',
});
...
export default function ComingSoonPage() {
  return (
    <section className="relative min-h-[80vh] overflow-hidden">
      <SmartImage src={unsplash(28, 1600, 1000)} alt="" fill priority sizes="100vw" fallbackSeed="coming-soon" />
      ...
      <div className="container relative flex min-h-[80vh] flex-col items-center justify-center py-20 text-center text-background">
        ...
        <h1 className="mt-6 max-w-3xl text-display balance">Two more desks. Same tape measure.</h1>
